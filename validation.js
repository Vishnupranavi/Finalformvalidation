  ...
  //username
   ...
   if(emailInput.value.trim()==''){
    setError(emailInput,'Provide Email Address');
      ...
      sessionStorage.setItem('unname',emailInput.value);
   }
   else{
    setError(emailInput,'Provide a Valid Email Address');
   }
  //  qualification
    if(document.getElementById('qualification').selectedIndex=="0"){
...
sessionStorage.setItem('username',document.getElementById('lastname').value);
